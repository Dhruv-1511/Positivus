  ...
  return (
    <div className='mt-40 px-20 md:px-12 md:mt-28'>
      <div className='flex md:flex-col md:items-center'>
        <p className='bg-customLime text-5xl p-2 rounded-lg font-medium md:text-xl md:text-center'>Case Studies</p>
      ...
      <div className='flex mt-20 bg-black rounded-3xl p-10 sm:flex-col '>
        ...
        <div>
          <div className='h-full w-px mx-10 bg-white sm:w-full sm:h-px sm:m-0 sm:mb-10' />
        </div>
        <div className='w-4/6 sm:w-full'>
